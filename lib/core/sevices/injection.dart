...
Future<void> setupInjection() async {
  ...
  getIt.registerLazySingleton<AuthRepository>(
    () => AuthRepositoryImp(authRemoteData: getIt()),
  );
  ...
  // >>>>>>>>>>> product Bloc
  getIt.registerLazySingleton<ProductRemoteData>(() => ProductRemoteData(getIt()),);
  getIt.registerLazySingleton<ProductRepository>(() => ProductRepositoryImp(productRemoteData: getIt()),);
  getIt.registerFactory<ProductBloc>(() => ProductBloc(productRepository: getIt()),);
}
